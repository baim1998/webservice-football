const ApiKey = "d3d37672a7a94825b731e06304f4dc1b";
        ...
        .then(restJson => {
            ...
            <div class="row">
                <div class="col s8"
                    ...
                    <ul>
                        <li -item"><h3>${restJson.name}</h3></li>
                        <li -item">Nama Club : ${restJson.shortName}</li>
                        <li -item">Berdiri : ${restJson.founded}</li>
                        <li -item">Asal : ${restJson.address}</li>
                        <li -item">Contact : ${restJson.phone}</li>
                        <li -item">Email : ${restJson.email}</li>
                        <li -item">Warna Club : ${restJson.clubColors}</li>
                    </ul>
            </div>
            </div>
            </div>
